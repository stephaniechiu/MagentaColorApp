...
//        menuButtonsArray = [premiumButton, emailButton, favoritesButton]
//        favoritesButton.isHidden = true
        ...
        emailButton.anchor(top: premiumButton.bottomAnchor, left: leftAnchor, paddingTop: 10, paddingLeft: 35, width: 350, height: 70)
